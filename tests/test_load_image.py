...
from tendrils.api import get_filters
from flows.load_image import load_image


# --------------------------------------------------------------------------------------------------
@pytest.mark.parametrize('fpath,siteid',
                         [['SN2020aatc_K_20201213_495s.fits.gz', 13], ['ADP.2021-10-15T11_40_06.553.fits.gz', 2],
...
target_coord = SkyCoord(ra=347.6230189, dec=7.5888196, unit='deg', frame='icrs')
