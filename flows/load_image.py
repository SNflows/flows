...
def main():
    filename = "../tests/input/ADP.2021-11-08T12_34_46.383.fits"
    img = load_image(filename, (325.772590825, -17.54410925))
    print(img.peakmax)
    return img
...
#                         filters_used.append(hdr.get(check_headers).strip())
#                 if len(filters_used) == 1:
#                     image.photfilter = {'V_Bes 530_80': 'V', 'R_Bes 650_130': 'R', "g'_SDSS 480_145": 'gp',
#                                         "r'_SDSS 618_148": 'rp', "i'_SDSS 771_171": 'ip', 'i_int 797_157': 'ip',
#                                         # Interference filter
#                                         "z'_SDSS 832_LP": 'zp'}.get(filters_used[0].replace('  ', ' '), filters_used[0])
#                 else:
