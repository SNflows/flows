...
def get_photometry(photid):
    ...
    if not os.path.isfile(photfile):
        ...
        r = requests.get('https://flows.phys.au.dk/api/download_photometry.php', params=params,
...
def upload_photometry(fileid, delete_completed=False):
    ...
    with tempfile.TemporaryDirectory(prefix='flows-upload-') as tmpdir:
        ...
        with open(fpath_zip, 'rb') as fid:
            r = requests.post('https://flows.phys.au.dk/api/upload_photometry.php', params={'fileid': fileid},
