...
class PSFBuilder:
    ...
    def star_size(self) -> int:
        ...
        ##Extra logger##
        logger.info("Using photometry.PSFBuilder.starsize")
    ...
    def extract_star_cutouts(self, star_xys: np.ndarray) -> List[np.ma.MaskedArray]:
        ...
        ##Extra logger##
        logger.info("Using photometry.PSFBuilder.extract_star_cutouts")
    ...
    def make_epsf(self, stars):
        ...
        ##Extra logger##
        logger.info("Using photometry.PSFBuilder.make_epsf")
...
class Photometry:
    ...
    def calculate_appflux(apphot_tbl: Table, apertures: CircularAperture, annuli: CircularAnnulus) -> Table:
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.calculate_appflux")
    ...
    def apphot(self, coordinates: ArrayLike, image: FlowsImage, fwhm: float, use_raw: bool = False) -> Table:
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.apphot")
    ...
    def create_photometry_object(self, fwhm: Union[float, u.Quantity], psf_model: photutils.psf.EPSFModel,
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.create_photometry_object")
    ...
    def psfphot(self, image: ArrayLike, init_table: Table) -> Tuple[BasicPSFPhotometry, Table]:
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.psfphot")
    ...
    def rescale_flux_error(phot_tables: Dict[int, Table],
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.rescale_flux_error")
    ...
    def get_fit_shapes(fwhm: Union[float, int], star_size: int, fwhm_min: int = 2,
        ...
        ##Extra logger##
        logger.info("Using photometry.Photometry.get_fit_shapes")
...
class PhotometryManager:
    ...
    def propogate_references(self):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.propogate_references")
    ...
    def background_subtract(self):
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.background_subtract")
    ...
    def recalculate_image_wcs(self, cm_timeout: float):
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.recalculate_image_wcs")
    ...
    def calculate_pixel_coordinates(self):
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.calculate_pixel_coordinates")
    ...
    def clean_reference_stars(self, rsq_min: float = 0.15):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.clean_reference_stars")
    ...
    def create_psf_builder(self) -> PSFBuilder:
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.create_psf_builder")
        return PSFBuilder(self.image, self.target, self.fwhm)

    def update_reference_with_epsf(self, stars):
    ##Extra logger##
        logger.info("Using photometry.PhotometryManager.update_reference_with_epsf")
    ...
    def create_epsf(self, psf_builder: PSFBuilder = None):
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.create_epsf")
    ...
    def prepare_target_and_references_for_photometry(self):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.prepare_target_and_references_for_photometry")
    ...
    def apphot(self) -> Table:
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.apphot")
    ...
    def psfphot(self, fit_shape: Optional[Union[int, Tuple[int, int]]] = None) -> Table:
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.psfphot")
    ...
    def raw_psf_phot(self, init_guess: Optional[Table] = None) -> Table:
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.raw_psf_phot")
    ...
    ##Extra logger##
        logger.info("Using photometry.PhotometryManager.diff_psf_phot")
    ...
    def rescale_uncertainty(self, psfphot_tbl: Table, dynamic: bool = True, 
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.resccale_uncertainty")
    ...
    def make_result_table(self, psfphot_tbl: Table, apphot_tbl: Table):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.make_result_table")
    ...
    ##Extra logger##
        logger.info("Using photometry.PhotometryManager.calculate_mag")
    ...
    def calculate_pixel_scale(self):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.calculate_pixel_scale")
    ...
    def add_metadata(self):
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.add_metadata")
    ...
    def create_from_fid(cls, fid: int, directories: Optional[DirectoryProtocol] = None,
        ...
        ##Extra logger##
        logger.info("Using photometry.PhotometryManager.create_from_fid")
...
def do_phot(fileid: int, cm_timeout: Optional[float] = None, make_plots: bool = True,
    ...
    ##Extra logger##
    logger.info("Using photometry.do_phot")
...
def timed_photometry(fileid: int, cm_timeout: Optional[float] = None, make_plots: bool = True,
    ...
    ##Extra logger##
    logger.info("Using photometry.timed_photometry")
...
def do_plots(pm: PhotometryManager, mag_fig: plt.Figure, mag_ax: plt.Axes):
    ...
    ##Extra logger##
    logger.info("Using photometry.do_plots")
